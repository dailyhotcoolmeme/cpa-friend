  ...
  return (
    <div>
      <section style={{ textAlign: 'center', padding: '60px 0' }}>
        ...
        <h1 style={{ fontSize: '2.0rem', fontWeight: '800', color: '#0f172a', marginTop: '20px', letterSpacing: '-0.02em' }}>
          우리는 고객을 <span style={{ color: '#2563eb' }}>최우선으로 일합니다.</span>
        </h1>
        <p style={{ fontSize: '1.0rem', color: '#64748b', marginTop: '24px', maxWidth: '700px', margin: '24px auto' }}>
